...
public class jt2Controler : MonoBehaviour
{
  public float targetPosition=0.0f;
    ...
    void Update()
    {
        currentPosition=(transform.eulerAngles.x);
        if (currentPosition>=180)
        {currentPosition=-(360-transform.eulerAngles.x);}
    ...
    if (attempt >= maxAttempts) {
        ...
        yield break;
            ...
            string urltoGet= "http://" + dataHost + "/api/jt2Control";
